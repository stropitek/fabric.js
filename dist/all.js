...
(function() {
  ...
  /**
   * ExtPencilBrush class
   * @class fabric.ExtPencilBrush
   * @extends fabric.BaseBrush
   */
  fabric.ExtPencilBrush = fabric.util.createClass(fabric.BaseBrush, /** @lends fabric.ExtPencilBrush.prototype */ {

    /**
     * Constructor
     * @param {fabric.Canvas} canvas
     * @return {fabric.ExtPencilBrush} Instance of a pencil brush
     */
    initialize: function(canvas) {
      this.canvas = canvas;
      this._points = [ ];
